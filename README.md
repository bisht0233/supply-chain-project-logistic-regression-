...
I took a dataset from Kaggle about Global Supply Chain disruptions. I wanted to see if I could predict on time status and create a Power-BI dashboard to highlight disruptions and trends 
